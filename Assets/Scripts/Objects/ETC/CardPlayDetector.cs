...
{
    /// <summary>
    /// 드래그 종료 시 카드가 이 Detector 안에 있는지를 판별하는 컴포넌트
    /// </summary>
    public class CardPlayDetector : MonoBehaviour
    {
        #region Fields and Properties
        [Tooltip("카드가 놓일 곳 이동할 Zone")]
        [SerializeField] private CardZone targetZone;

        [Tooltip("카드 모드 선택기를 표시하는 컴포넌트")]
        ...
        /// <summary>
        /// 해당 카드가 이 Detector 박스 안에 있는지 판단
        /// </summary>
        ...
        /// <summary>
        /// 카드 놓기 처리 로직 (카드 타입에 따라 다르게 UI 표시)
        /// </summary>
        ...
        /// <summary>
        /// 숫자 카드 처리 로직
        /// 필드 풀 체크 및 CardModeSelector 표시
        /// 실제 네트워크 동기화는 CardModeSelector에서 카드 배치 확정 후 수행
        /// </summary>
        ...
        private void HandleNumberCard(Transform card)
        {
            ...
            // NetworkCard 컴포넌트 확인 (네트워크 동기화에 필요 필수)
            ...
            // 모드 선택 팝업 띄워 CardModeSelector 표시

            // 배치 이벤트 발생 (CardModeSelector가 구독하고 있을 것)
        ...
        #region Network Sync
        /// <summary>
        /// 카드 배치 완료 후 네트워크 동기화 알림
        /// CardModeSelector에서 모드 선택 완료 후 호출하는 정적 메서드
        /// NetworkCard 시스템을 활용한 개선된 네트워크 동기화
        /// </summary>
        /// <param name="card">배치된 카드</param>
        /// <param name="targetZone">배치될 Zone</param>
