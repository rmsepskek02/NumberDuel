...
namespace Manager
{
    ...
    /// <summary>
    /// 덱 데이터 관리 매니저
    /// DeckStacker와 연동하여 실제 카드 데이터를 관리하고 드로우 기능을 제공
    /// </summary>
    public class DeckManager : Singleton<DeckManager>
    {
        ...
        // DeckStacker 참조 (시각적 덱과 연동)
        private DeckStacker playerDeckStacker;
        private DeckStacker opponentDeckStacker;

        // 덱 구성 정보
        private const int DECK_SIZE = 30;
        private const int NUMBER_CARDS_PER_VALUE = 4; // 각 숫자별 4장
        private const int OPERATOR_CARDS_PER_TYPE = 2; // 각 연산자별 2장
        ...
        private void Start()
        {
            // DeckStacker 찾기 (씬에 배치된 DeckStacker들을 자동 감지)
            FindDeckStackers();
        }
        #endregion
